...
class Post
{
    ...
    //insert data
    public function addPost($title,$description,$image,$data,$slug)
    {
       $sql = "INSERT INTO posts(title,description,image,created_at,slug)VALUES ('$title','$description','$image','$data','$slug')";
    ...
    {
        $sql = "
        SELECT * FROM posts LEFT JOIN comments on posts.slug=comments.slug GROUP BY
